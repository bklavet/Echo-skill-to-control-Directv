...
Follow the steps below with the following additions
	- there are now 2 custom slots to define Control_List and Guide_Info
	- When you create your zip file include node_modules with AlexaSkill and index
